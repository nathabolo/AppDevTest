...
/**
 * Created by User7 on 2017/02/24.
 */
...
public class PlaceDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(mPlace!=null){
            ...
            String url = "https://developers.google.com/maps/documentation/android-api/signup";
            String key = "AIzaSyD9R9XeGTCX2SnUDh2MeoJX7PPWwrpmTiw";
    ...
    private Bitmap downloadImage(String strUrl) throws IOException {
        ...
        try{
            ...
            Log.d("Error while loading url", e.toString());
        }finally{
            iStream.close();
        }
        return bitmap;
    ...
    private class ImageDownloadTask extends AsyncTask<String, Integer, Bitmap> {
        ...
        protected void onPostExecute(Bitmap result) {
            ...
            Toast.makeText(getActivity().getBaseContext(), "Photo downloaded successfully", Toast.LENGTH_SHORT).show();
        }
    }
}
